    ...
    const char *settings)
{
    ...
    params.set(CameraParameters::KEY_SUPPORTED_FLASH_MODES, "off,auto,torch");
    params.set(CameraParameters::KEY_SUPPORTED_FOCUS_MODES, "auto,infinity,macro,continuous-video");
