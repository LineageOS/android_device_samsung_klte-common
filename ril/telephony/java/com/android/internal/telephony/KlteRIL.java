...
public class KlteRIL extends RIL {
    ...
    responseSignalStrength(Parcel p) {
         ...
         *  calculating the value for getLteLevel(). Set the snr value to -1
         *  so only the rsrp or the rssi values are used for the signal
         *  level that is used to display the bars in the signal cluster.
         */
        lteRssnr = SignalStrength.INVALID;
