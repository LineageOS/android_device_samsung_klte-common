...
public class KlteRIL extends RIL {
    ...
    private boolean isLollipopRadio = false;
    ...
    responseCallList(Parcel p) {
        ...
        DriverCall dc;
        isLollipopRadio = SystemProperties.get(RIL_VERSION_PROPERTY) == "lp";
    ...
    dialEmergencyCall(String address, int clirMode, Message result) {
        ...
        if(isLollipopRadio) rr = RILRequest.obtain(RIL_REQUEST_DIAL_EMERGENCY_LL, result);
